...
#pragma warning restore 649
        ...
        private void OnCollisionEnter(Collision collision)
        {
            ...
            {
                _rigidbody.AddForce(-transform.forward * 500, ForceMode.Impulse);

                gameObject.GetComponent<PlayerHealth>().Hit = 15;
            }
        }
